...
public class HomeController {
	...
	public String adminDashboard(Model model) {
		model.addAttribute("title", "AdminDashboard - Smart Contact Manager");
		return "admindashboard";
	}

	@PostMapping("/do_register")
	public String registerUser(@Valid @ModelAttribute("user") User user, BeanPropertyBindingResult result,
